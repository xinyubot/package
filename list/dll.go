...
/*
	Below is the slightly modified implementation of Go Authors's
	standard library implementation of a Doubly Linked List
*/
...
//	}
//
// Element[V] is an element of a linked list.
